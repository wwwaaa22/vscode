...
const rpmDependenciesGenerator = require('./linux/rpmDependenciesGenerator');
...
function prepareRpmPackage(arch) {
	...
	return function () {
		...
		const dependencies = rpmDependenciesGenerator.getRpmDependencies('./build/linux/linux-installer', binaryDir);
